...
import {
  ...
  DoorOpen, ChevronLeft, ChevronRight, BarChart3, Menu, X, Mail, BookOpen, LifeBuoy,
} from "lucide-react";
...
export default function Layout({ children }: { children: ReactNode }) {
  ...
  const navItems = [
    ...
    { label: t("nav.support", "Suporte"), path: "/support", icon: LifeBuoy, roles: ["admin", "professor", "student", "institution_admin"] },
